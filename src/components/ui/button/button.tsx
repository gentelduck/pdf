...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const { icon: animationIconChildren, iconPlacement = "right" } =
      animationIcon ?? {};
    const { children: AnimationIcon, ...animationIconProps } =
      animationIconChildren ?? {};
    const {
        ...
        <TooltipTrigger asChild>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              {!loading ? (
                Icon && !!icon && !loading && <Icon {...iconProps} />
              ) : (
