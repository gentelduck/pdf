      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex items-center space-x-2">
            ...
            <CopyButton
              link={`${process.env.NEXT_PUBLIC_SITE_URL}${pdfFile}`}
            />
          </div>
...
export const ImageGalleryPreview = ({}: ImageGalleryPreviewProps) => {
  ...
  return (
    <div className="w-full h-full max-auto gap-4 flex flex-col p-12">
      ...
      <div className="gap-4 p-4 rounded-lg items-center border border-border min-h-[600px] flex flex-col place-content-center">
        {previews.length > 0 ? (
